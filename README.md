# X世代Pokemon傷害計算器
有別於傳統單對單計算器，本計算器能同時計算無限隻怪，另附有HP、速度調整功能(前身為次世代Pokemon傷害計算器)
...
注意:Desktop版不會經常更新，且macOS版以外未確保順利運行
...
### 2021-11-24
新增下載圖片功能，以作PWA離線時使用(圖片總大小約5MB，下載時可能會引起硬件遲鈍問題)
