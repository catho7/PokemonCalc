# X世代Pokemon傷害計算器
有別於傳統單對單計算器，為無限隻怪同時計算的傷害計算器，另附有HP、速度調整功能(前身為次世代Pokemon傷害計算器)
...
## Donation
你可以[Donation](https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=PAGW77ASG7VHY&source=url)支持我的開發